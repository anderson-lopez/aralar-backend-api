...
def get_all_notifications() -> Dict[str, Any]:
    ...
    try:
        ...
        result = notifications_service.get_all_notifications(
            location=location,
        ...
        # Reuse pagination metadata from service
        ...
        for notification in notifications:
            try:
                ...
                if not chosen_content and default_locale and default_locale in locales:
                    chosen_content = (
                        (locales.get(default_locale) or {}).get("data", {}).get("content")
                    )
...
def update_notification_locale(
    notification_id: str, locale: str, data: Dict[str, Any], meta: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
...
def get_notifications_by_location(location: str) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"items": notifications, "total": total, "skip": 0, "limit": total}
    except Exception as e:
